    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 dark:bg-slate-950">
      <Card className="w-full max-w-md mx-4 rounded-sm shadow-sm border-slate-200">
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <p className="text-xs text-zinc-500 font-semibold uppercase tracking-widest mb-4">404 Page Not Found</p>
          ...
          <Link href="/">
            <span className="inline-flex items-center justify-center h-10 px-6 rounded-sm bg-zinc-900 hover:bg-zinc-800 text-white text-sm font-bold transition-colors cursor-pointer">
